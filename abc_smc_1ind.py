#Update Npars to 5000 to increase exploration space
#1 inducer
#29/3/2022
...
def main(argv):
    ...
    Sequential_ABC(x_data, ncpus=ncpuss, initial_dist=initdist, final_dist=finaldist, prior_label=pl, Npars=5000, #Adjusted to 5000 to increase exploration
